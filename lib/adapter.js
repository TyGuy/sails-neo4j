...
var adapter = module.exports = (function() {
  ...
  function getRelatedNodesWithDirection(connection, collection, predecessorParams,
    ...
    q = ['MATCH (a)-[r:' + relationshipType + relationshipParams + ']' + connector + '(n)']

    predecessorClause = utils.nodeCriteriaClause(collection, predecessorParams, predecessorNamespace, 'a')
    q.push('WHERE ' + predecessorClause)

    successorClause = utils.nodeCriteriaClause(successorCollectionName, successorParams, successorNamespace, 'n')
