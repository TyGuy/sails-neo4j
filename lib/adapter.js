...
var adapter = module.exports = (function() {
  ...
  function getRelatedNodesWithDirection(connection, collection, predecessorParams,
    ...
    if (flipNodes) {
      q = [`MATCH (${succNodeName})-[r:` + relationshipType + relationshipParams + ']' + connector + `(${predNodeName})`]
    } else {
      q = [`MATCH (${predNodeName})-[r:` + relationshipType + relationshipParams + ']' + connector + `(${succNodeName})`]
    }
